...
def run_evaluation():
    ...
    test_data = [
        ...
        ("dolapta patlıcan ve kıyma var", "ingredient_input"),
        ("yumurta domates biberim var", "ingredient_input"),
        ("mercimeğim var ne yapsam", "ingredient_input"),
        ("evde un ve şeker var", "ingredient_input"),
        ("ne pişirebilirim", "ingredient_input"),
